...
// physics
let velosityX = -2; //pipes moving left speed 
let velosityY = 0; //bird jump speed
let gravity = 0.3;
...
window.onload = () => {
    ...
    btmPipeImg = new Image();
    btmPipeImg.src = "https://github.com/ImKennyYip/flappy-bird/blob/master/bottompipe.png?raw=true";


    context.fillStyle = "white";
    context.font = "40px sans-serif";
    context.fillText("Press S key to Start", 5, 45);   
